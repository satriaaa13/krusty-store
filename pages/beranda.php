...
<body>
  ...
  <!--Kategori-->
  <div class="container">
    <div class="Judul-kategori" style="background-color: #fff; padding: 10px 15px">
      <h3>KATEGORI</h3>

      <div class="row text-center row-container mt-2">
        <div class="col-lg-2 col-md-3 col-sm-4 col-6">
          <div class="menu-kategori">
            <a href="#"><img src="../assets/kategori/baju.png" class="img-category" /></a>
            <p>Baju</p>
          </div>
        </div>
        <div class="col-lg-2 col-md-3 col-sm-4 col-6">
          <div class="menu-kategori">
            <a href="#"><img src="../assets/kategori/celana.png" class="img-category" /></a>
            <p>Celana</p>
          </div>
        </div>
        <div class="col-lg-2 col-md-3 col-sm-4 col-6">
          <div class="menu-kategori">
            <a href="#"><img src="../assets/kategori/tas.png" class="img-category" /></a>
            <p>Tas</p>
          </div>
        </div>
        <div class="col-lg-2 col-md-3 col-sm-4 col-6">
          <div class="menu-kategori">
            <a href="#"><img src="../assets/kategori/jamtangan.png" class="img-category" /></a>
            <p>Jam Tangan</p>
          </div>
        </div>
        <div class="col-lg-2 col-md-3 col-sm-4 col-6">
          <div class="menu-kategori">
            <a href="#"><img src="../assets/kategori/sepatu.png" class="img-category" /></a>
            <p>Sepatu</p>
          </div>
        </div>
        <div class="col-lg-2 col-md-3 col-sm-4 col-6">
          <div class="menu-kategori">
            <a href="#"><img src="../assets/kategori/elektronik.png" class="img-category" /></a>
            <p>Elektronik</p>
          </div>
        </div>
      </div>
  ...
  <div class="container mt-5" style="width: 70%">
    <div class="Judul-kategori" style="background-color: #fff; padding: 17px 15px">
      <h4>PRODUK</h4>
      <div class="row">

        <!-- Menambahkan kode PHP untuk menampilkan produk dari database -->
        <?php
        ...
        if (mysqli_num_rows($result) > 0) {
          ...
          <div class="col-lg-2 col-md-3 col-sm-4 col-6 mt-2">
              <div class="card text-center">
                  <img src="../assets/produk/' . $foto . '" class="card-img-top" alt="...">
                  <div class="card-body">
                      <h5 class="card-title">' . $nama . '</h5>
                      <p class="card-text">Rp. ' . number_format($harga, 0, ',', '.') . '</p>
                      <a href="singleproduk.php?id=' . $id_produk . '" class="btn btn-dark d-grid">Beli</a>
                  </div>
              </div>
          </div>';
          }
